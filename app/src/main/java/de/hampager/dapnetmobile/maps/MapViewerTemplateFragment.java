...
public abstract class MapViewerTemplateFragment extends Fragment {
    ...
    protected MapView createMapViews() {
        ...
        mapView.getMapZoomControls().setZoomControlsGravity(Gravity.BOTTOM|Gravity.START);
        return mapView;
    }
...
//        View mapView =inflater.inflate(getMapViewId(),container,false);
        View v =inflater.inflate(getLayoutId(),container,false);

        this.mapView=(MapView)v.findViewById(getMapViewId());
        createMapViews();
     ...
     */
    //TODO: Rausnehmen, trifft bei fragment nicht zu
    ...
    protected MapView getMapView() {
        ...
        return (MapView) getActivity().findViewById(getMapViewId());
    }
